...
const Hero = () => {
  const stats = [
    ...
    { icon: Users, value: "2,000+", label: "Satisfied Tenants" },
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          src={heroImage}
          alt="Modern commercial building at sunset"
          ...
          >
            {stats.map((stat, index) => (
              <motion.div
                ...
                className="bg-primary-foreground/10 backdrop-blur-md rounded-xl p-6 border border-primary-foreground/10"
              >
      ...
      <div className="absolute bottom-0 left-0 right-0 h-24 z-10">
        ...
        >
          <path
            d="M0 100V40C240 80 480 0 720 40C960 80 1200 0 1440 40V100H0Z"
